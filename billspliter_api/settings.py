"""
Django settings for billspliter_api project.
...
ALLOWED_HOSTS = ['billspliterapi.azurewebsites.net']
...
ROOT_URLCONF = 'billspliter_api.urls'
...
WSGI_APPLICATION = 'billspliter_api.wsgi.application'
